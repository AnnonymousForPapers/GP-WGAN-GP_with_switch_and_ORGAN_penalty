...
for method in method_array:
    ep = 'epoch1000'
    data_path = data_file + 'result_brain/' + method + '/' + ep + '/NetMHCpan_prediction_' + ep + '.csv'
    prediction = pd.read_csv(data_path)
    ...
    plt.savefig(data_file + 'result_brain/' + method + '/' + ep + "/IC50 compare.png", bbox_inches='tight')
    plt.show()
