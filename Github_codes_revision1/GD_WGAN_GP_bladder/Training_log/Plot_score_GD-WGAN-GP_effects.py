...
os.chdir('D:/PhD thesis/GAN/TMLR/Submit/Github_codes_revision1/GD_WGAN_GP_bladder/Results')
...
name_array = [r"GD-WGAN-GP ($\gamma_{max}=1$)",
...
fig = plt.figure(figsize=(8, 6))  # Taller to accommodate legend
...
ax.set_title("Immunogenicity Score vs. Epoch from Various GD-WGAN-GPs", fontsize=20)
...
# Save before showing
plt.tight_layout()
plt.savefig("Ablation_GD-WGAN-GP_immunogenicity_scores.png", dpi=600, bbox_inches="tight")
plt.show()
...
ax.set_title("Unique Peptide Rate vs. Epoch from Various GD-WGAN-GPs", fontsize=20)
ax.tick_params(labelsize=16)
ax.grid(True)
...
# Save before showing
plt.tight_layout()
plt.savefig("Ablation_GD-WGAN-GP_G_unq_rate.png", dpi=600, bbox_inches="tight")
plt.show()
...
plt.xlabel("Epoch", fontsize=20)
plt.ylabel("Loss", fontsize=20)
plt.title("Loss vs. Epoch from various GD-WGAN-GPs", fontsize=20)
plt.xticks(fontsize=20)
plt.yticks(fontsize=20)
plt.grid(True)
plt.legend(fontsize=16, loc='center', bbox_to_anchor=(0.5, 0., 0, -0.8))

# Save before showing
plt.tight_layout()
plt.savefig("Ablation_GD-WGAN-GP_loss.png", dpi=600, bbox_inches="tight")
plt.show()
