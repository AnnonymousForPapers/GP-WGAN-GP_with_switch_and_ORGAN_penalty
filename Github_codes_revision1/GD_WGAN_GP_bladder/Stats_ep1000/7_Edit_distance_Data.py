...
for method, method_name in zip(method_array, name_array):
    if "Bladder" in method_name:
        data_path = data_file + 'result/' + method + '/Bladder.4.0_test_mut.csv'
    if "Brain" in method_name:
        data_path = data_file + 'result/' + method + '/Brain.4.0_test_mut.csv'
