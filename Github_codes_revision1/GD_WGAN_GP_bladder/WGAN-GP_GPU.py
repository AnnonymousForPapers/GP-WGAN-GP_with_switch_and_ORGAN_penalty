...
output_dir = data_file + 'result/WGAN-GP/epoch' + str(num_epochs)
...
np.save(output_dir+'/Ggen_time_each.npy', array13)
np.save(output_dir+'/Dpred_time_each.npy', array14)
np.save(output_dir+'/CNNPred_time_each.npy', array15)
