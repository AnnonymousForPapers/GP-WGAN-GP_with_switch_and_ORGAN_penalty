...
name_array = [r"MolGAN best ($\lambda_M=0.5$)",
...
for method, method_name, num_epochs in zip(method_array, name_array, num_epochs_array):
    data_path = data_file + 'result/' + method + '/' + ep + '/best_deepimmuno-GANRL-bladder-epoch' + str(num_epochs) + '-batch' + str(batch_size) + '_rmv.txt'
    ...
    plt.savefig(outdir + '/best_df_EditDistance_epoch' + str(num_epochs) + '.png')
    plt.show()
    ...
    np.save(outdir + '/best_EditDistance_epoch' + str(num_epochs) + '-batch' + str(batch_size) + '_all_value', all_value)
    np.save(outdir + '/best_EditDistance_epoch' + str(num_epochs) + '-batch' + str(batch_size) + '_whole1', whole1)
    np.save(outdir + '/best_EditDistance_epoch' + str(num_epochs) + '-batch' + str(batch_size) + '_whole2', whole2)
