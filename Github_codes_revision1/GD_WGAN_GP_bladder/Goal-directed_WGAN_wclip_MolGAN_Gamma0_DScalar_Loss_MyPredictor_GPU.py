...
output_dir = data_file + 'result/GD_WGAN_wclip_MolGAN_Gamma0_DScalar_Loss_MyPredictor/epoch' + str(num_epochs)
...
for epoch in range(num_epochs):
    ...
    for mini_batch in real_dataloader:
        ...
        if counter % d_steps == 0:
            ...
            """
            g_lamda = 0 # <- Change here
            g_error_total = -g_lamda * torch.mean(dg_fake_pred) - (1 - g_lamda)*torch.mean(sg_fake_pred)
